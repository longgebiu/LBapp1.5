...
public class MainActivity extends AppCompatActivity {
        ...
        customTitleBar.setOnTitleClickListener(new CustomTitleBar.TitleOnClickListener() {
            ...
            public void onRightClick() {
               // Toast.makeText(MainActivity.this, "点击了右边的保存按钮", Toast.LENGTH_SHORT).show();
                Intent intent=new Intent();
                intent.setClass(MainActivity.this,CallPhone.class);
                //Intent intent=new Intent(IntentTest.this,MyActivity.class);
                MainActivity.this.startActivity(intent);
            }
        });
    ...
    private void initView() {
        ...
        bottom_bar.addItem(new BottomNavigationItem(R.drawable.home, getString(R.string.home)))
                .addItem(new BottomNavigationItem(R.drawable.order, getString(R.string.order)))
                .addItem(new BottomNavigationItem(R.drawable.daohang, getString(R.string.daohang)))
                .initialise();
